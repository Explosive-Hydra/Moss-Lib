...
public sealed class Blocks
{
    ...
    public static implicit operator ushort(Blocks block) => block?.Id ?? 0;
    ...
    public static readonly Blocks SteelTile = new(6, "steeltile", 5000f, "steel", "Steel", "Mediocre", isMetallic: true);
    ...
    public static readonly Blocks HeatResistantAlloy = new(10, "heatresistantalloy", 15000f, "steel", "Steel", "Mediocre", isMetallic: true);
    ...
    public static readonly Blocks Scaffolding = new(21, "scaffolding", 200f, "steel", "Steel", "Mediocre", isMetallic: true, noVariation: true);
    ...
    public static Blocks FromId(ushort id) => id switch
    {
        0 => Air,
        1 => LightRock,
        2 => Gravel,
